...
const Landing: FC = () => {
  return (
    <div className={`flex flex-col items-center bg-white justify-center px-4 ${sora.className}`}>
      <Image src="/cloud.png" className='relative md:left-[674px] top-[50px] w-[11%] hidden md:block' alt="" height={50} width={50} />
      <h1 className="text-3xl md:text-6xl font-bold text-center text-black tracking-tight px-4">
        Unlock Your Potential with <br className="hidden md:block" /> Our Expertise
      </h1>
      <p className="mt-4 text-center text-[#00000066] mb-5 text-base md:text-lg px-4">
