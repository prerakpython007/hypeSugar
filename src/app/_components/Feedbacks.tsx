    ...
    <div className={`w-full py-10 md:py-20 ${sora.className}`}>
      <div className="w-[95%] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-white p-6 md:p-8 md:relative md:left-10 border-2 border-black rounded-[30px] md:rounded-[50px] hover:translate-y-[-8px] transition-all">
          ...
          <div className="bg-white p-6 md:p-8 mx-auto md:mx-0 border-2 card-2 border-black hover:translate-y-[-8px] transition-all">
            
            <p className="text-black pt-3 md:pt-5 leading-relaxed">
            "The platform has completely transformed how we manage our cloud infrastructure. Highly recommended!""The platform has completely transformed how we manage our cloud infrastructure. Highly recommended!""The platform has completely transformed how 
            </p>
            <div className="ml-2 md:ml-4 border-2 flex bg-white border-black mt-8 md:mt-16 rounded-full">
                <div className='p-2'>
              <img src="/avatar.avif" alt="Client" className="w-10 h-10 md:w-12 md:h-12 rounded-full" />
              </div>
              <div className='py-2 md:py-4'>
          ...
          {/* Card 3 */}
          <div className="bg-white p-6 md:p-8 border-2 border-black rounded-[30px] md:rounded-[50px] hover:translate-y-[-8px] transition-all">
